...
<div class="card">
    ...
    <div class="card-body">
        ...
        while ($r = $q->fetch_array()) {
            ...
            <td>" . $r['pengadaan'] . "</td>
            <td>
                <a class='btn btn-success btn-sm' href='admin.php?target=prodi&action=edit&id=" . $r['tgl_inspeksi'] . "'><i class='fa-solid fa-pen-to-square'></i>Edit</a>
                <a class='btn btn-danger btn-sm' href='admin.php?target=prodi&action=delete&id=" . $r['tgl_inspeksi'] . "'><i class='fa-solid fa-trash'></i>Hapus</a>
            </td>
        </tr>";
            $no++;
        }
...
>>>>>>> a5603cf2a180449085cd40d0dcc682cba6385367
