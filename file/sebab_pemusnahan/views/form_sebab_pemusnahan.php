<div class="card">
    ...
    <div class="card-body">
        <form method="post" action="admin.php?target=sebab&action=input" data-parsley-validate class="form-horizontal form-label-left">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <div class="col-md-6 col-sm-6 col-lg-12">
                    <input type="text" name="id_pemusnahan" class="form-control" />
                </div>
            </div>
            <div class="mb-3">
                <label class="control-label col-md-3 col-sm-3 col-lg-12" for="first-name">
