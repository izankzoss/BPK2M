...
<div class="card">
    ...
    <div class="card-body">
        <form method="post" action="admin.php?target=tempat&action=update" data-parsley-validate class="form-horizontal form-label-left">
            <input type="hidden" name="id" value="<?php echo $rows->tmp_simpan; ?>">
            <div class="mb-3">
                <label class="control-label col-md-3 col-sm-3 col-lg-12" for="first-name">
                    Tempat Simpan
                </label>
                <div class="col-md-6 col-sm-6 col-lg-12">
                    <input type="text" name="name_simpan" id="tmp_simpan" value="<?php echo $rows->nama_simpan; ?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
            </div>
            <div class="mb-3">
                <label class="control-label col-md-3 col-sm-3 col-lg-12" for="first-name">
